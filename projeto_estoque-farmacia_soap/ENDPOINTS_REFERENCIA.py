...
POST_CONSULTAR_DISPONIBILIDADE = {
    ...
    "descrição": "Consulta disponibilidade de um medicamento (baseado em resposta.xsd)",
    "parâmetros": {
        "corpo": {
            "codigo_medicamento": "int (obrigatório)",
        ...
        "respostas": [
            {
                "codigo_medicamento": 789123,
                "disponivel": 1,
                "observacao": "Disponível em LOTE123 - Validade: 2027-06-30"
            }
        ]
    },
        ...
        "respostas": [
            {
                "codigo_medicamento": 789123,
                "disponivel": 0,
                "observacao": "Quantidade insuficiente. Disponível: 3 un. Solicitado: 5 un."
            }
        ]
    },
    "status": 200,
